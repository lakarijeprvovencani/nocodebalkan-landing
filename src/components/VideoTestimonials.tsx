        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {videos.map((video, index) => (
            <motion.div
              ...
              className="group relative max-w-sm mx-auto md:max-w-none"
            >
                ...
                {playingVideo !== video.id && (
                  <>
                    ...
                    >
                      ...
                      >
                        <div className="w-16 h-16 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center border-2 border-white/20 group-hover:border-purple-500/50 transition-all duration-300">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 pointer-events-none">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-gray-300">Video iskustvo</span>
                      </div>
                    </div>
                  </>
                )}
