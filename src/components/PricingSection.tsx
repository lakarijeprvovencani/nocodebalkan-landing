    ...
    <section id="pricing" className="py-12 md:py-24 bg-gray-900 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="relative bg-gray-800/90 backdrop-blur-xl rounded-2xl p-4 md:p-8">
            <div className="text-center mb-8 md:mb-12">
              <h3 className="text-lg md:text-2xl text-gray-300 mb-4 md:mb-8">Mesečna pretplata</h3>
              <div className="inline-flex items-baseline justify-center gap-2 bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 bg-clip-text text-transparent">
                <span className="text-4xl md:text-7xl font-bold">$49</span>
                <span className="text-lg md:text-2xl">mesečno</span>
              </div>
            </div>
            ...
            <div className="space-y-4 md:space-y-6 mb-8 md:mb-12">
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <span className="text-sm md:text-lg text-gray-300">{feature}</span>
                </motion.div>
              ))}
            </div>
            ...
            <div className="text-center">
              ...
              <motion.a
                ...
                className="inline-flex items-center px-8 py-3 md:px-12 md:py-4 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 text-white text-base md:text-xl font-medium rounded-xl shadow-lg shadow-purple-500/20 hover:shadow-purple-500/40 transition-all duration-300 group"
