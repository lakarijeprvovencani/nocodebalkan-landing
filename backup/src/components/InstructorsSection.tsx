  ...
  return (
    <section className="py-12 md:py-24 bg-gray-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-2xl md:text-5xl font-bold text-purple-500 mb-3 md:mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 md:auto-rows-fr">
          {instructors.map((instructor, index) => (
            ...
            >
              ...
              <motion.div
                className="relative bg-gray-800/80 backdrop-blur-sm rounded-2xl overflow-hidden border border-gray-700/50 group-hover:border-transparent transition-all duration-300 md:h-full"
                whileHover={{ y: -8 }}
              >
                ...
                <div className="relative flex flex-col items-center gap-4 md:gap-6 p-4 md:p-8 md:h-full">
                  {/* Image container with enhanced effects */}
                  <motion.div 
                    className="relative w-40 h-40 md:w-64 md:h-64 flex-shrink-0"
                  ...
                  >
                    ...
                    >
                      <div className="w-7 h-7 md:w-10 md:h-10 bg-yellow-400 rounded-full flex items-center justify-center shadow-lg shadow-yellow-400/50">
                        <Sparkles className="w-4 h-4 md:w-6 md:h-6 text-gray-900" />
                      </div>
                    </motion.div>
                  </motion.div>
                  ...
                  <div className="flex-1 text-center w-full">
                    ...
                    <p className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400 font-medium mb-3 md:mb-4 text-base md:text-lg">
                      {instructor.title}
                    </p>
                    ...
                    <div className="flex flex-wrap gap-2 md:gap-3 justify-center">
                      {instructor.achievements.map((achievement, i) => (
                        ...
                        >
                          ...
                          <div className="relative flex items-center gap-1.5 md:gap-2 px-3 py-1.5 md:px-4 md:py-2 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-full text-xs md:text-sm text-purple-300 border border-purple-500/30 group-hover/badge:border-purple-500/60 transition-all">
                            <Star className="w-3 h-3 md:w-3.5 md:h-3.5 text-purple-400" fill="currentColor" />
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 bg-purple-500/10 rounded-full text-purple-300 mb-3 md:mb-4">
            <Trophy className="w-4 h-4 md:w-5 md:h-5" />
            <span className="text-sm md:text-base">Preko 5000 zadovoljnih polaznika</span>
          </div>
