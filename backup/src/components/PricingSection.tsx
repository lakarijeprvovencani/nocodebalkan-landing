          ...
          <div className="relative bg-gray-800/90 backdrop-blur-xl rounded-2xl p-4 md:p-8">
            ...
            <div className="text-center">
              ...
              <motion.a 
                ...
                className="inline-flex items-center px-8 py-3 md:px-12 md:py-4 text-white text-base md:text-xl font-medium rounded-xl shadow-lg transition-all duration-300 group hover:opacity-90"
