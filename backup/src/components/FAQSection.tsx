  ...
  return (
    <section className="py-12 md:py-24 bg-gray-900 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <motion.h2 
          className="text-2xl md:text-5xl font-bold text-center mb-8 md:mb-16 bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent"
        >
            ...
            >
              ...
              <div className={`relative bg-gray-800/90 backdrop-blur-sm rounded-xl transition-all duration-300 ${
                ...
                <button
                  ...
                  className="w-full px-4 py-3 md:px-6 md:py-4 text-left flex items-center justify-between"
                >
                  ...
                  >
                    {openIndex === index ? (
                      <Minus className="w-5 h-5 md:w-6 md:h-6 text-purple-400" />
                    ) : (
                      <Plus className="w-5 h-5 md:w-6 md:h-6 text-purple-400" />
                    )}
                  </motion.div>
                </button>
                ...
                <AnimatePresence>
                  {openIndex === index && (
                    ...
                    >
                      <div className="px-4 pb-3 md:px-6 md:pb-4 text-sm md:text-base text-gray-300">
                        {faq.answer}
                      </div>
                    </motion.div>
                  )}
