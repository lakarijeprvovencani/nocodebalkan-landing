      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <motion.div
            ...
            className="w-14 h-14 md:w-20 md:h-20 mx-auto mb-4 md:mb-6 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 p-0.5"
          >
            <div className="w-full h-full rounded-full bg-gray-900 flex items-center justify-center">
              <span className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent">+</span>
            </div>
          </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
          {miniCourses.map((course, index) => (
            ...
            >
              ...
              />
              <div className="relative bg-gray-800 rounded-xl p-4 md:p-6 h-full transform transition-all duration-500 group-hover:translate-y-[-4px] group-hover:shadow-xl">
                <div className="flex items-start gap-3 md:gap-4">
                  <motion.div 
                    className={`w-12 h-12 md:w-16 md:h-16 rounded-lg md:rounded-xl bg-gradient-to-r ${course.color} p-2.5 md:p-3 shrink-0`}
